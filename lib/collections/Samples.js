...
_.extend(Sample.prototype, {
  ...
  fadeInCurve: function(){
    if(this.fades.in.shape == "custom"){
      return DrumApp.FadeCurveBufferCreators["custom"](1, this.fades.in.controlPoints );
    } else {
      return DrumApp.FadeCurveBufferCreators[this.fades.in.shape](1);
    }
  },

  fadeOutCurve: function(){
    if(this.fades.out.shape == "custom"){
      return DrumApp.FadeCurveBufferCreators["custom"](-1, this.fades.out.controlPoints );
    } else {
      return DrumApp.FadeCurveBufferCreators[this.fades.out.shape](-1);  
    }
  }
