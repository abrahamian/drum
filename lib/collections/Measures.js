MeasureSchema = new SimpleSchema({
  ...
  'beats' : {
    ...
    custom: function(){
      ...
      console.log(self.value, self.field('numberOfBeats').value);
      // console.log(this.value);
      if(self.isSet){
        if(self.value.length != self.field('numberOfBeats').value) { 
          return "oh no";
        } else {
          console.log('yayyy');
        }
...
Meteor.methods({  
  'Measures/update' : function(measureId, args){
    console.log(measureId, args);
